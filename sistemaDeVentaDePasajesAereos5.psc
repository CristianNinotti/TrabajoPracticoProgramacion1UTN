				...
				caso 1 : 
					...
					Repetir
						...
						Segun opcionVuelo Hacer
							caso 1: 
								destino1(vueloDestino1, filas, columnas, contadorRuta1, capacidadPasajeros, 0)
								contadorRuta1 = contadorRuta1+1
								capacidadPasajeros = capacidadPasajeros -1        // Correcion profesora
							caso 2: 
...
SubProceso ordenamientoPasajerosDestino1(vueloDestino1 Por Referencia, filas, columnas) //Ordenamiento por nombre y apellido
	
	Para i = 1 hasta filas con Paso 1 Hacer
		para j = 0 hasta filas-1 Con paso 1 Hacer
			
			Si vueloDestino1[i,1] > vueloDestino1[i + 1, 1] Entonces  // Si es mayor Cristian a Alberto
